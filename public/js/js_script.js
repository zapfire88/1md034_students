...
for(i = 0; i < 5; i++)
{
	...
	if(menu[i].dispAllergies().length > 0)
  {
  	...
  	myMenu.appendChild(listItemName);
		myMenu.appendChild(listItemImg);
		myMenu.appendChild(listItemDesc1);
		myMenu.appendChild(listItemDesc2);
		myMenu.appendChild(listItemCalories);
		myMenu.appendChild(listItemAllergies);
  }
